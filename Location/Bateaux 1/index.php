        ...
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" >
                    <a class="dropdown-item font-weight-bold" href="../Bateaux%200/index.php"><i class="fa-solid fa-ship"></i> Bateau 1</a>
                    <a class="dropdown-item font-weight-bold" href="./index.php"><i class="fa-solid fa-ship"></i> Bateau 2 </a>
                </div>
            </li>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="../Sources/Images/bruce-warrington-eMqG0_PpoGg-unsplash.jpg" class="d-block w-100" alt="...">
                    </div>
